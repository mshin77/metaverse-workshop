...
![](figures/qr.png){width="217"}
:::
:::

------------------------------------------------------------------------

![](figures/DOE.png){fig-align="center"}[Source:]{style="font-size: 0.65em"} [Office of Elementary & Secondary Education](https://oese.ed.gov/resources/safe-school-environments/keeping-students-safe-online/){style="font-size: 0.65em"}

------------------------------------------------------------------------

## `Metaverse vs Cybersecurity Trends`

![](figures/trend.png)[Source:]{style="font-size: 0.65em"} [Google Trend](https://trends.google.com/trends/explore?date=all&q=metaverse,cybersecurity&hl=en){style="font-size: 0.65em"}
...
![](https://www.techrepublic.com/wp-content/uploads/2023/01/learn-about-metaverse-bundle.jpg){width="341"} [Source:]{style="font-size: 0.65em"} [TechRepublic](https://www.techrepublic.com/article/learn-about-metaverse-bundle/){style="font-size: 0.65em"}
:::
:::

## `History of the Metaverse`

![](figures/history.png){fig-align="center" width="767"}

[Source:]{style="font-size: 0.65em"} [Ziaul (March, 2022)](https://metaversetroop.com/history-of-the-metaverse/){style="font-size: 0.65em"}

[Web 3.0, Metaverse Standards]{fig-align="center" width="767"} [https://metaverse-standards.org/](https://metaverse-standards.org/){fig-align="center" width="767"}

## `Technologies Used in the Metaverse`

![](https://www.mdpi.com/electronics/electronics-12-00391/article_deploy/html/images/electronics-12-00391-g001.png){fig-align="center" width="620"}

[Source:]{style="font-size: 0.65em"} [Gupta et al. (2023)](https://www.mdpi.com/2079-9292/12/2/391){style="font-size: 0.65em"}
...
[Source:]{style="font-size: 0.65em"} [GeoGebra](https://www.geogebra.org/m/agpb7bq7){style="font-size: 0.65em"}
...
[Source:]{style="font-size: 0.65em"} [https://builtin.com](https://builtin.com/healthcare-technology/ar-virtual-reality-healthcare){style="font-size: 0.65em"}
...
[Source:]{style="font-size: 0.65em"} [Microsoft Mesh](https://www.engadget.com/microsoft-mesh-holograms-hololens-ar-vr-164001796.html){style="font-size: 0.65em"}
...
![](https://static-prod.adweek.com/wp-content/uploads/2022/11/epic-games-lego-child-safety-2-2022.jpg.webp){fig-align="center"} [Source:]{style="font-size: 0.65em"} [Lepitak (November, 2022)](https://www.adweek.com/brand-marketing/how-lego-and-epic-games-aim-to-make-online-experiences-safe-for-children/){style="font-size: 0.65em"}
:::
:::
...
[Source:]{style="font-size: 0.65em"} [Meta](https://about.fb.com/news/2022/05/introducing-digital-collectibles-to-showcase-nfts-instagram/){style="font-size: 0.65em"}
...
[Source:]{style="font-size: 0.65em"} [Ministry of Education, Republic of Korea]{style="font-size: 0.65em"}
...
[Source:]{style="font-size: 0.65em"} [Forkast News](https://forkast.news/headlines/south-korea-metaverse-capital-city-seoul/){style="font-size: 0.65em"}
